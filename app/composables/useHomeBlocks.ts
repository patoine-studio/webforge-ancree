...
export function useHomeBlocks(): PageBlock[] {
  ...
  const services: PageBlock = {
    ...
    items: isEn
      ? [
          { icon: 'lucide:bug', title: 'Ants and cockroaches', body: 'Targeted colony treatment, inside and around the foundation, with follow-up to keep them from coming back.', href: `${p}/extermination/ants`, featured: true },
          { icon: 'lucide:rat', title: 'Mice and rats', body: 'Inspection, entry-point sealing and complete rodent control.', href: `${p}/extermination/rodents` },
          { icon: 'lucide:bed', title: 'Bed bugs', body: 'Discreet, guaranteed thermal and residual treatment so you sleep easy.', href: `${p}/extermination/bed-bugs` },
          { icon: 'lucide:hexagon', title: 'Wasps and hornets', body: 'Safe nest removal, high or low, with no risk to the family.', href: `${p}/extermination/wasps` },
          { icon: 'lucide:building-2', title: 'Commercial pest control', body: 'Preventive programs for restaurants, shops and buildings, compliant with standards.', href: `${p}/extermination/commercial` }
        ]
      : [
          { icon: 'lucide:bug', title: 'Fourmis et coquerelles', body: 'Traitement ciblé des colonies, à l’intérieur comme autour de la fondation, avec un suivi pour empêcher le retour.', href: `${p}/extermination/fourmis`, featured: true },
          { icon: 'lucide:rat', title: 'Souris et rats', body: 'Inspection, scellement des points d’entrée et contrôle complet des rongeurs.', href: `${p}/extermination/rongeurs` },
          { icon: 'lucide:bed', title: 'Punaises de lit', body: 'Traitement thermique et résiduel, discret et garanti, pour dormir tranquille.', href: `${p}/extermination/punaises-de-lit` },
          { icon: 'lucide:hexagon', title: 'Guêpes et frelons', body: 'Retrait sécuritaire des nids, en hauteur ou au sol, sans risque pour la famille.', href: `${p}/extermination/guepes` },
          { icon: 'lucide:building-2', title: 'Extermination commerciale', body: 'Programmes préventifs pour restaurants, commerces et immeubles, conformes aux normes.', href: `${p}/extermination/commercial` }
        ]
  }
